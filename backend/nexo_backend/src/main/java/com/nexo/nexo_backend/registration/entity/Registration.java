...
public class Registration {
    ...
    private com.nexo.nexo_backend.payments.entity.PaymentStatus paymentStatus = com.nexo.nexo_backend.payments.entity.PaymentStatus.PENDING;

    @OneToOne(mappedBy = "registration", cascade = CascadeType.ALL)
    private com.nexo.nexo_backend.payments.entity.Payment payment;
